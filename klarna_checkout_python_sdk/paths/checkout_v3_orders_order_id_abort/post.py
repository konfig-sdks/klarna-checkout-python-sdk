...
SchemaFor200ResponseBody = OrderSchema
    ...
    async def _aabort_order_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/checkout/v3/orders/{order_id}/abort',
            headers=_headers,
        )
...
class AbortOrderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aabort_order(
        self,
        order_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._abort_order_mapped_args(
            order_id=order_id,
        )
        return await self._aabort_order_oapg(
    ...
    def abort_order(
        ...
        return self._abort_order_oapg(
            path_params=args.path,
        )

class AbortOrder(BaseApi):
    ...
    async def aabort_order(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aabort_order(
            order_id=order_id,
            **kwargs,
        )
        if validate:
    ...
    def abort_order(
        ...
        raw_response = self.raw.abort_order(
            order_id=order_id,
        )
        if validate:
            return OrderPydantic(**raw_response.body)
