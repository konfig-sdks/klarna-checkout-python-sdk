...
class BaseApi(api_client.Api):
    ...
    def _get_order_details_mapped_args(
        self,
        order_id: str,
    ...
    async def _aget_order_details_oapg(
        self,
...
class GetOrderDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_order_details(
        self,
        order_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_order_details_mapped_args(
            order_id=order_id,
        )
        return await self._aget_order_details_oapg(
    ...
    def get_order_details(
        ...
        return self._get_order_details_oapg(
            path_params=args.path,
        )

class GetOrderDetails(BaseApi):
    ...
    async def aget_order_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_order_details(
            order_id=order_id,
            **kwargs,
        )
        if validate:
    ...
    def get_order_details(
        ...
        raw_response = self.raw.get_order_details(
            order_id=order_id,
        )
        if validate:
            return OrderPydantic(**raw_response.body)
